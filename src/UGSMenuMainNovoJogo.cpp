...
UGSMenuMainNovoJogo::UGSMenuMainNovoJogo()
{
    ...
    /// Parte do c�digo que procura as pastas das musicas// comeca de 1 e quando chega no numero de uma pasta que
...
void UGSMenuMainNovoJogo::draw(sf::RenderWindow& window){
    ...
    /// esta parte garante que haver� apenas 1 aloca��o de UGSMenuMainNovoJogoStep2 e que ser� desenhado somente ele
    if(wasChose){
        if(wasChooseControl){
